    ...
    var wordCard: [String] {
        ...
        case .sentence:
            return [
                ...
                "이연 연옥 '오열 아이으으' 우운 우앙오 안욱 아이으으 아운에 어음입이아. 욱애 음악영온아을은 앙안오연안의 엉옹 요인으오 으으오 악아 잋 악옥을 애애은 응역, 알운우을 우연어 아이으아이 오와아은 일역, 우애애와 앤 어이으애어을 옵았읍이아.",
                ...
                "아욱의 이오 에임 원이을 으으오 악읍아은 알아오 에오을 알요아연어 어 이앙 인옹이응 알아오와 인안안의 아욱애외은 우의이아에 외었읍이아.",
                "바둑의 기초 게임 원리를 스스로 학습하는 알파고 제로를 발표하면서 더 이상 인공지능 알파고와 인간간의 바둑대회는 무의미하게 되었습니다.",
                "앙요 완아아오 안안외연 영원을 앙운애 의아의 운인와 인알, 옃 아이 안안안 엄아 응을 옹애 아은 원인에 의안 인영영응이 아인 엇을 왁인안 우 인안알 우 있읍이아.",
